...
public class DataAccessLayer {
    ...
    public void generateHTML() {
        ...
        try {
            ...
            bwr.write("<table class=tg><tr><th class=tg-h1 colspan=" + 3 + ">TRUNK</th></tr>");
            bwr.newLine();
            ...
            bwr.write("<table class=tg2><tr><th class=tg-h2 colspan=" + 3 + ">RC</th></tr>");
            bwr.newLine();
            bwr.write("<tr><td class=tg-th2>Step</td><td class=tg-th2>Ergebnis</td><td class=tg-th2>Zuletzt grün</td></tr>");
            bwr.newLine();
            for (ReportType r : rc) {
                bwr.write("<tr><td class=tg-td2><a href=https://ci.infonova.at/job/A1OpenNet/job/" + r.getReportName()
                    + ">" + r.getReportName() + "</a></td></a><td class=tg-td2>" + r.getResult()
            ...
            bwr.newLine();
            for (ReportType r : bf) {
                bwr.write("<tr><td class=tg-td3><a href=https://ci.infonova.at/job/A1OpenNet/job/" + r.getReportName()
                    + ">" + r.getReportName() + "</a></td></a><td class=tg-td3>" + r.getResult()
            ...
            for (ReportType r : uat4) {
                bwr.write("<tr><td class=tg-td4><a href=https://ci.infonova.at/job/A1OpenNet/job/" + r.getReportName()
                    + ">" + r.getReportName() + "</a></td></a><td class=tg-td4>" + r.getResult()

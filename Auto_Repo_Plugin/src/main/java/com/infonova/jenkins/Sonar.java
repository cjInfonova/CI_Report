        ...
        for (JsonNode jnode : content) {
            ...
            if (jnode.has("msr")) {
                for (JsonNode jnode2 : jnode) {
                    ...
                    if (jnode2.has("lines"))
                        lines = jnode2.get("val").asInt();
                    if (jnode2.has("ncloc"))
                        ncloc = jnode2.get("val").asInt();
                    if (jnode2.has("classes"))
                        classes = jnode2.get("val").asInt();
                    if (jnode2.has("files"))
                        files = jnode2.get("val").asInt();
                    if (jnode2.has("directories"))
                        directories = jnode2.get("val").asInt();
                    if (jnode2.has("functions"))
                        functions = jnode2.get("val").asInt();
                    if (jnode2.has("accessors"))
                        accessors = jnode2.get("val").asInt();
                    if (jnode2.has("statements"))
                        statements = jnode2.get(var).asInt();
                    if (jnode2.has("blocker_violations"))
                        blocker_violations = jnode2.get("val").asInt();
                    if (jnode2.has("critical_violations"))
                        critical_violations = jnode2.get("val").asInt();
                    if (jnode2.has("major_violations"))
                        major_violations = jnode2.get("val").asInt();
                    if (jnode2.has("minor_violations"))
                        minor_violations = jnode2.get("val").asInt();
                    if (jnode2.has("info_violations"))
                        info_violations = jnode2.get("val").asInt();
                    if (jnode2.has("new_violations"))
                        new_violations = jnode2.get("val").asInt();
                    if (jnode2.has("open_issues"))
                        open_issues = jnode2.get("val").asInt();
                    if (jnode2.has("sqale_index"))
                        sqale_index = jnode2.get("val").asDouble();
                    if (jnode2.has("new_technical_debt"))
                        new_technical_debt = jnode2.get("val").asDouble();

                    if (jnode2.has("lines"))
                        lines_ch = jnode2.get(var).asInt();
                    if (jnode2.has("ncloc"))
                        ncloc_ch = jnode2.get(var).asInt();
                    if (jnode2.has("classes"))
                        classes_ch = jnode2.get(var).asInt();
                    if (jnode2.has("files"))
                        files_ch = jnode2.get(var).asInt();
                    if (jnode2.has("directories"))
                        directories_ch = jnode2.get(var).asInt();
                    if (jnode2.has("functions"))
                        functions_ch = jnode2.get(var).asInt();
                    if (jnode2.has("accessors"))
                        accessors_ch = jnode2.get(var).asInt();
                    if (jnode2.has("statements"))
                        statements_ch = jnode2.get(var).asInt();
                    if (jnode2.has("blocker_violations"))
                        blocker_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("critical_violations"))
                        critical_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("major_violations"))
                        major_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("minor_violations"))
                        minor_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("info_violations"))
                        info_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("new_violations"))
                        new_violations_ch = jnode2.get(var).asInt();
                    if (jnode2.has("open_issues"))
                        open_issues_ch = jnode2.get(var).asInt();
                    if (jnode2.has("sqale_index"))
                        sqale_index_ch = jnode2.get(var).asDouble();
                    if (jnode2.has("new_technical_debt"))
                        new_technical_debt_ch = jnode2.get(var).asDouble();
                }
                if (jnode.has("issues")) {
                    for (JsonNode jnode2 : jnode) {

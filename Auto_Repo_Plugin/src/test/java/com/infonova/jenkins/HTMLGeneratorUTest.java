...
public class HTMLGeneratorUTest extends EasyMockSupport {
    ...
    public final static List<Job> jobList = Arrays.asList(new Job("Test1", "FAILED", 1, 2, "no"), new Job("Test2",
        "PASSED", 0, 2, "no"), new Job("Test2", "SKIPPED", 0, 2, "no"));
    public final static List<Failure> failList = Arrays.asList(new Failure(1, "class1", "fail all", "ff", "FAILED",
        "Test1"), new Failure(0, "class2", "", "", "PASSED", "Test2"), new Failure(0, "class3", "", "", "PASSED",
        "Test2"));
